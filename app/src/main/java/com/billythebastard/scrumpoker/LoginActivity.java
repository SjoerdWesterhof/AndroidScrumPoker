...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userNameView = (EditText) findViewById(R.id.loginActivity_userName);
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.loginActivity_signinbutton);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                userNameView.setError(getString(R.string.error_incorrect_password));
